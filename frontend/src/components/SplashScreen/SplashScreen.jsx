...
const floatingIcons = [
  { id: 1, Icon: Ticket, color: '#d91c49', size: 48, top: '15%', left: '10%' },
  { id: 2, Icon: Music, color: '#05a19f', size: 56, top: '20%', left: '80%' },
  { id: 3, Icon: MapPin, color: '#8fb300', size: 42, top: '70%', left: '15%' },
  { id: 4, Icon: Calendar, color: '#d91c49', size: 50, top: '80%', left: '75%' },
  { id: 5, Icon: Star, color: '#d48a1c', size: 60, top: '40%', left: '5%' },
  { id: 6, Icon: Sparkles, color: '#05a19f', size: 45, top: '50%', left: '85%' },
  { id: 7, Icon: Heart, color: '#d91c49', size: 38, top: '10%', left: '50%' },
  { id: 8, Icon: Zap, color: '#8fb300', size: 55, top: '85%', left: '45%' },
];
